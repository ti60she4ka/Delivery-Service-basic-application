...
public class ShowProductsByAttributesAction implements Action {
  ...
  public ShowProductsByAttributesAction(ArticleController articleController,
  ...
  private void filterByShops(List<Article> productStorages) {
    List<Shop> allShops = (List<Shop>) shopController.getAll();
    ...
    productStorages
        .removeIf(item -> !isProductPresentInOneOfShops(item.getProduct(), finalShopsForSearch));
  }
